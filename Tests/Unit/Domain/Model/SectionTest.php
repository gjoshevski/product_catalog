...
/**
 * Test case for class \TEND\ProductCatalog\Domain\Model\Section.
 *
...
class SectionTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \TEND\ProductCatalog\Domain\Model\Section
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \TEND\ProductCatalog\Domain\Model\Section();
	}
	 ...
	 * @test
	 */
	public function getAllowFilteringReturnsInitialValueForBoolean() {
		$this->assertSame(
			FALSE,
			$this->subject->getAllowFiltering()
		);
	}
	 ...
	 * @test
	 */
	public function setAllowFilteringForBooleanSetsAllowFiltering() {
		$this->subject->setAllowFiltering(TRUE);
	...
	public function setPropertiesForObjectStorageContainingPropertySetsProperties() {
		$property = new \TEND\ProductCatalog\Domain\Model\Property();
