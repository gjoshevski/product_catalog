...
/**
 * Test case for class TEND\ProductCatalog\Controller\ProductController.
 *
...
class ProductControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * @var \TEND\ProductCatalog\Controller\ProductController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('TEND\\ProductCatalog\\Controller\\ProductController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllProductsFromRepositoryAndAssignsThemToView() {
		...
		$productRepository = $this->getMock('TEND\\ProductCatalog\\Domain\\Repository\\ProductRepository', array('findAll'), array(), '', FALSE);
	...
	public function showActionAssignsTheGivenProductToView() {
		$product = new \TEND\ProductCatalog\Domain\Model\Product();
